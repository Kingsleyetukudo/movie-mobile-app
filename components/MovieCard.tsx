    ...
    return (
        <Link href={`/movies/${id}`} asChild>
            ...
            <TouchableOpacity className='w-[30%]'>
                ...
                <Image source={{
                    uri: poster_path ? `https://image.tmdb.org/t/p/w500${poster_path}` : 'https://placehol.co/600x400/1a1a1a/ffffff.png'
                ...
                <View className='flex-row justify-between items-center'>
                    <View className='flex-row items-center justify-start gap-x-1'>
                        ...
                        <Text className='text-xs text-white front-bold uppercase'>{Math.round(vote_average / 2)}</Text>
                    </View>
                    <View>
