              ...
              {trendingMovies && (
                <View className="mt-10">
                  ...
                  <FlatList
                    ...
                    )} keyExtractor={(item) => item.movie_id.toString()} horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={{ paddingRight: 10 }} className="mb-4 mt-3" />
                </View>
              )}
              ...
              <>
                ...
                <FlatList
                  data={movies} renderItem={({ item }) => (
                    ...
                    justifyContent: "flex-start", gap: 20, paddingRight: 10, marginBottom: 10
