...
const search = () => {
    ...
    return (
        <View className='flex-1 bg-primary'>
            ...
            <Image source={images.bg} className='flex-1 absolute z-0' resizeMode='cover' />
            ...
            }} contentContainerStyle={{ paddingBottom: 100 }} ListHeaderComponent={
                <>
